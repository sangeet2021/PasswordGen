...
function App() {
  ...
  }, [length, numAllowed, charAllowed, setPassword]) //for optimization
  ...
  return (
    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-500 bg-gray-500">
      ...
      <div className='flex shadow rounded-lg overflow-hidden mb-4'>
        ...
        <button className='outline-none bg-blue-700 text-white px-3 py-1 shrink-0 cursor-pointer' onClick={copyPasswordToClip}>Copy</button>
      </div>
